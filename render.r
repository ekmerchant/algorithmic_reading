...
setwd("/users/emily/dropbox/ucdavis/teaching/quarters/winter_2020/sts205/sts205_w2020")

#list all the RMD files in your site's directory
files <- list.files(path = ".", pattern = '*.rmd', full.names = FALSE)

#this function runs over all the RMD files and renders them to their default output (hopefuly HTML)
...
courseTitle <- "STS 205"
navTitle <- "STS 205: Algorithmic Reading"
profName <- "M"
